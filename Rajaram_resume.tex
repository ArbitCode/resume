...
\begin{center}
    ...
    Vinayaka Nagar, HAL Old Airport Road, Bangalore, India \\ \vspace{1pt}
    \small \raisebox{-0.1\height}\faPhone\ \href{tel:+919205574290}{(+91) 920-557-4290} ~ \href{mailto:Rajaramsharma422@gmail.com}{\raisebox{-0.2\height}\faEnvelope\  \underline{Rajaramsharma422@gmail.com}} ~
    \href{https://linkedin.com/in/ArbitCode}{\raisebox{-0.2\height}\faLinkedin\ \underline{linkedin.com/in/ArbitCode}}  ~
    \href{https://github.com/ArbitCode}{\raisebox{-0.2\height}\faGithub\ \underline{github.com/ArbitCode}}
    \vspace{-8pt}
\end{center}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Electronics Company}{May 2021 -- August 2022}
