...
\begin{center}
    ...
    ~ \href{https://leetcode.com/ArbitCode}{\textbf{\includegraphics[height=10pt, width=10pt]{leetcode.png}}\ \underline{ArbitCode}}
    \vspace{-8pt}
\end{center}
...
\section{EXPERIENCE}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Encore Capital Group}{Feb 2021 -- Nov 2021}
...
\section{TECHNICAL SKILLS}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: C++, Java, JavaScript, SQL (MySQL, SQL Server)} \\
     \textbf{Developer Tools}{: VS Code, Visual Studio, Eclipse, Android Studio} \\
     \textbf{Technologies/Frameworks}{: Node, Linux, Git, HTML, CSS, Jenkins, Docker} \\
    }}
 \end{itemize}
 \vspace{-16pt}
