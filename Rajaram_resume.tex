  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Worked on \textbf{MuleSoft's Anypoint Plateform} using its connector implemented API to transfer files from \textbf{SFTP} to \textbf{S3} storage and automated mail send if new file uploaded or modified existing file on SFTP.}
...
\section{TECHNICAL SKILLS}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Technologies/Frameworks}{: Node.Js, Linux, Git, HTML, CSS, Jenkins, Docker, JIRA, Database (MongoDB, PostgreSQL, Dynamodb), AWS} \\
    }}
 \end{itemize}
 \vspace{-16pt}
